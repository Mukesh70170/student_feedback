...
<head>
    ...
    <title>Student_Feedback-MIET</title>
    <link rel="stylesheet" href="style-1.css">
    <link rel="shortcut icon" href="img/download__1_-removebg-preview.png" type="image/x-icon">
    <style>
        .container {
  position: relative;
  width: 350px;
...
<body>
    ...
    <div class="header-div">
        <header>
            <img src="../img/best-college-logo.webp" style="width:100%; height:auto; max-width:650px;"/>
            <a href="https://www.mangalmay.org" target="_blank" class="college-web button-30">Go To College Website</a>
        </header>
    </div>
  ...
  font-size: 30px;"><b>Student's Online Feedback System</b></p></div>
   <div class="main">
    ...
    <div class="container">
        ...
        <div class="brand-logo"><img src="../img/download__1_-removebg-preview.png" alt="" width="60px" height="90px"></div>
    ...
    <footer>
    <p>&copy; Designed and Developed by Dept.Of CSE (2020-2024) @MIET, Greater Noida <br /> Visit : <a href="https://www.mangalmay.org">Mangalmay Institute of Engineering and Technology, Greater Noida</a></p>
</footer>
