...
<title>Login-Student Feedback MIET</title>
...
<form  method="post" class="form-welcome">
  ...
  <table class="table table-borderless">
    <div class="brand-logo"><img src="../img/download__1_-removebg-preview.png" alt="" width="60px" height="90px" style="margin-left: 20px;"></div><br/>
    <p>&nbsp;</p><p>&nbsp;</p><br/>
    
    <tr>
        <td><label for="Academic-Year"><b>Note&nbsp;:&nbsp;</b>You are accessed to login only with your college Official Mail Id<br />e.g.,&nbsp;20ru1a0505@miet.ac.in</label></td>
        <br />
    </tr>
