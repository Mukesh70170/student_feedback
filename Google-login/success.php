...
<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.8.1/css/all.css" integrity="sha384-50oBUHEmvpQ+1lW4y57PTFmhCaXp0ML5d60M1M7uH2+nqUivzIebhndOJK28anvf" crossorigin="anonymous">
    <title>Welcome-page-Student Feedback MIET</title>
...
<form  method="post" class="form-welcome" action="redirect.php">
  ...
  <table class="table table-borderless">
    <div class="brand-logo"><img src="../img/download__1_-removebg-preview.png" alt="" width="60px" height="90px" style="margin-left: 20px;"></div>
    <tr>
...
<button type="submit" name="submit" class="feed-btn">Give Feedback!</button>
  ...
  <footer>
    <p>&copy; Designed and Developed by Dept.Of CSE (2020-2024) @MIET, Greater Noida <br /> Visit : <a href="https://www.mangalmay.org">Mangalmay Institute of Engineering and Technology, Greater </a></p>
</footer>
